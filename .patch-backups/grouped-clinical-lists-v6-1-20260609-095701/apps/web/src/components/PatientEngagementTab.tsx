...
function MessageSubgroup({
  ...
  return (
    <details className="pe-clinical-subgroup" open={open} onToggle={(event) => setOpen(event.currentTarget.open)}>
            ...
            {items.map((message) => {
              ...
              return (
                <tr key={message.id}>
                  ...
                  <td><strong className="pe-clinical-row-title">{message.title}</strong></td>
