...
export const defaultDiseaseRuleTemplates: DefaultDiseaseRuleTemplate[] = [
  ...
  },
  {
    ...
    vitalThresholdRules: [
      ...
      { id: 'thr-chd-sbp-high', vitalType: 'SYSTOLIC_BP', displayName: '收缩压', unit: 'mmHg', operator: 'GTE', thresholdValue: 160, riskLevel: RiskLevel.HIGH, alertTitle: '冠心病合并血压高危预警', alertDescription: '冠心病患者血压高危，需关注胸痛风险。', followUpAction: '当日随访并建议复测。', sortOrder: 20 },
    ],
    followUpPolicies: [
