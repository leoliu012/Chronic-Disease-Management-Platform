  ...
  return (
    <section className="ops-section">
      ...
      <div className="ops-card-grid ops-card-grid-wide">
        ...
        <MetricCard label="自动收敛过期链接" value={String(m.expiredLinks ?? 0)} tone="ok" />
      </div>
  ...
  return (
    <section className="ops-section">
      ...
      <div className="ops-card-grid ops-card-grid-wide">
        ...
        <MetricCard label="待分配患者" value={String(integrity.patientsWithoutResponsibleNurse)} tone={integrity.patientsWithoutResponsibleNurse > 0 ? 'warn' : 'ok'} note="进入待认领队列，不视为数据错误" />
